...
import { ContactLinksColorMap, CustomLink, CustomNode, Link } from "@/types/graph";
import { GraphCaseCollector } from "./GraphCaseCollector";
import { Kruskal } from "./Kruskal";
import { COLOR_FOR_GENETIC_DISTANCE_LINKS, COLOR_PALETTE_LINKS } from "@/colors/colorPalettes";
import i18next from "i18next";
import { createColorByIndex } from "../graphs";
