...
import { CaseUpload } from "@/modules/data_management/services/data_upload/validation/CasesValidation";
 ...
 * @returns
 */
export const persistGroupsForCategories = async (caseData: CaseUpload, pathogenId: number) => {
    let groups = [];
