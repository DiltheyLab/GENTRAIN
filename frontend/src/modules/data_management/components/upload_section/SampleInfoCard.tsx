import { useGetCaseByFastaId } from "@/modules/core/hooks/database/cases/useGetCaseByFastaId";
...
export function SampleInfoCard({ fastaId }: { fastaId: string }) {
    ...
    return (
        <div>
            <div className="mb-2">
                <h4 className="mb-1 leading-none text-sm">Fall</h4>
                <p className="text-sm text-muted-foreground">{caseData?.case_id}</p>
            </div>
            <div>
                <h4 className="mb-1 leading-none text-sm">Registrierungsdatum</h4>
