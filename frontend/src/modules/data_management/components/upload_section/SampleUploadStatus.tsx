            ...
            {!isUploading && (
                <>
                    <div className="w-full flex flex-wrap gap-2">
                        <small>
                            Folgende Samples wurden in der Fastadatei gefunden und werden dem Datenbestand hinzugefügt.
                            Durch Hovern über eine Fasta ID können Sie sich weitere Informationen anzeigen lassen und
                            durch Klick auf das Kreuz die jeweilige Sequenz vom Upload ausschließen.
                        </small>
