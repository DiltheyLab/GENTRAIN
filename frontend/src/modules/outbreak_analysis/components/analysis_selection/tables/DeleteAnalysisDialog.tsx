...
type DeleteAnalysisDialogProps = {
    row: Row<AnalysisSchema>;
};

export const DeleteAnalysisDialog = forwardRef<HTMLButtonElement, DeleteAnalysisDialogProps>(({ row }, ref) => {
...
DeleteAnalysisDialog.displayName = "AnalysisDeleteDialog";
