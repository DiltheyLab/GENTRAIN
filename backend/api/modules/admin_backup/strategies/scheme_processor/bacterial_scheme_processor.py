from backend.modules.admin.strategies.scheme_processor.scheme_processor_strategy import (
    SchemeProcessorStrategy,
)
...
class BacterialSchemeProcessor(SchemeProcessorStrategy):
    ...
    def extract_files(self, zip_file):
        ...
        for filename in zip_filenames:
            if (
                ".schema_config" in filename
                or ".genes_list" in filename
                or ".fasta" in filename
            ):
