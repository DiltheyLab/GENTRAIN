...
class BasePathogen(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Pathogen']] = 'Pathogen'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.PathogenActions[_PrismaModelT]':
        from .client import get_client

        return actions.PathogenActions[_PrismaModelT](client or get_client(), cls)
