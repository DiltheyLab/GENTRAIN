...
class Prisma(SyncBasePrisma):
    ...
    pathogen: 'actions.PathogenActions[models.Pathogen]'
    ...
    def __init__(
        ...
        *,
        ...
        self.pathogen = actions.PathogenActions[models.Pathogen](self, models.Pathogen)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/api/prisma/schema.prisma',
        }
...
class Batch:
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.pathogen = PathogenBatchActions(self)
