...
from src.domains.pathogen_registry.routes.api import get_all_pathogens, get_pathogen, download_scheme, \
...
def test_pathogen_scheme_endpoint_returns_file_response(app, mocker, make_pathogen_resource, pathogen_type):
    with app.test_request_context():
        ...
        mock_download_scheme_action = mocker.patch("src.domains.pathogen_registry.routes.api.download_scheme_action", return_value=expected_response)
...
@pytest.mark.parametrize("pathogen_type, example_data_type, file_pattern, mimetype",
...
def test_pathogen_example_data_endpoint_returns_file_response(app, mocker, make_pathogen_resource, pathogen_type,
    ...
    with app.test_request_context():
        ...
        mock_download_example_data_action = mocker.patch("src.domains.pathogen_registry.routes.api.download_example_data_action",
                     return_value=expected_response)
