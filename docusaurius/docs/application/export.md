...
![DropDown Menü öffnen](/img/application/export/Drop Down Menü öffnen.png)
...
![Abfrage anklicken](/img/application/export/Abfrage anklicken.png)
...
![Namensfeld für Abfrage](/img/application/export/Namensfeld für Abfrage.png)
...
![Datensatz Auswahl Fall](/img/application/export/Datensatz Auswahl Fall.png)
...
![Kategorie Alle Felder](/img/application/export/Kategorie Alle Felder.png)
...
![Patient/-in des Falles Erweiterung](/img/application/export/Patientin des Falles Erweiterung.png)
...
![Query starten](/img/application/export/Query starten.png)

Achten Sie bitte darauf, dass die resultierende Tabelle in jedem Fall die unten stehenden Spalten beinhaltet.

![Fälle übersicht](/img/application/export/Fälle übersicht.png)
...
![Speichern](/img/application/export/Speichern.png)
...
![Speichern erfolgreich](/img/application/export/Speichern erfolgreich.png)
...
![Speichern unter mit Name](/img/application/export/Speichern unter mit Name.png)
...
![Datensatztyp Kontakt-COVID-19](/img/application/export/Datensatztyp Kontakt-COVID-19.png)
...
![Kontakte Übersicht](/img/application/export/Kontakte Übersicht.png)
...
![Such Abfragen öffnen](/img/application/export/Such Abfragen öffnen.png)
...
![Abfragen öffnen](/img/application/export/Abfragen öffnen.png)
