...
| ---------------------------------------- | ----------------------------------------------------------------------------------------------- | ------------------------------------------------- | ---------------------------------------------------------------------------------- |
| Data Upload                              | Upload of FASTA / CSV files                                                                     | Cases, sequences, contacts                        | Data basis for outbreak analyses                                                   |
| Data Export                              | Export of data stored in IndexedDB                                                              | Entire application data                           | Persistent data management, state sharing, backups                                 |
| Data Import                              | Import of data stored in IndexedDB                                                              | Entire application data                           | Persistent data management, state sharing, backups                                 |
...
| Persistence of Sequence Analysis Results | Temporary persistence in Redis cache (max 30 minutes)                                           | Mutation information                              | Retaining the results if the user leaves the application during analysis           |
| Persistence of Sequence Chunks           | Temporary persistence in Redis cache (until all chunks have been transmitted or max 30 minutes) | Pseudonymised sequences, pseudonymised assemblies | Reliable web socket transmission despite large amounts of data                     |
